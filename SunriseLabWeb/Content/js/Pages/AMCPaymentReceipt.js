                ...
                if (data.Data != null && data.Data.length > 0) {
                    ...
                    if (AMCAmount > 0) {
                        $('#divpayment #myTableBody').html(
                            ...
                            '<td>' +
                            '<input type="text" onkeyup="LenCheckr(\'' + AMCAmount + '\')"  maxlength="10" id="txt_PaidAmt_1" class="form-control form-control-sm PaidAmt" value="" autocomplete="off" style="text-align: end;">' +
                            '</td>' +
                            '</tr>');
                        $("#btnSave").show();
                    }
